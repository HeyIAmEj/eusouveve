    ...
    (function(mod) {
      ...
      function scriptHint(editor, keywords, getToken, options) {
        ...
        if (/\b(?:string|comment)\b/.test(token.type))
          return;
        var innerMode = CodeMirror2.innerMode(editor.getMode(), token.state);
      ...
      ;
      CodeMirror2.registerHelper("hint", "javascript", javascriptHint);
      ...
      CodeMirror2.registerHelper("hint", "coffeescript", coffeescriptHint);
...
export default require_javascript_hint();
//# sourceMappingURL=codemirror_addon_hint_javascript-hint.js.map
